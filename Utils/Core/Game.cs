namespace Utils.Core
{
    public class Game : Microsoft.Xna.Framework.Game
    {
        ...
        protected override void Update(GameTime gameTime)
        {
            ...
            {
                // print warning to console if an update takes more than 16ms
                // At 60 updates per second, every update should take less than 16.6ms
                // if it takes longer we could see a game slowdown
                // this is generally undetectable if there is a one off update that goes over by 2-3x
                LoggingUtil.info($"WARN: update took {(watch.ElapsedTicks / 10000f).ToString("00.000")}ms");
            }
        }
